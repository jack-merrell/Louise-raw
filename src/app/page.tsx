      ...
      >
        ...
        <div className="grid items-start gap-x-12 gap-y-12 pt-5 lg:grid-cols-[minmax(0,62vw)_minmax(340px,29vw)] lg:justify-between lg:pt-5">
          <Reveal delay={0.18}>
            ...
            >
              I help founder-led companies diagnose and fix the commercial
              systems behind growth — across sales, marketing, retention, CRM,
          ...
          <Reveal
            delay={0.32}
            className="w-full self-center justify-self-start lg:mt-[14vh] lg:justify-self-end"
          >
            <Image
        ...
        <Reveal
          delay={0.42}
          className="grid gap-6 pb-8 pt-10 lg:absolute lg:bottom-14 lg:left-8 lg:w-[58vw] lg:grid-cols-1 lg:pb-0 lg:pt-0"
        >
